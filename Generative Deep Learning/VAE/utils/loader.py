...
from tensorflow.keeras.datasets import mnist, cifar100, cifar10
...
def load_fashion_mnist(input_rows, input_cols, path = './data/fashion/fashion_mnist_train.csv'):
...
def load_cifar(label, num):
    if num == 10:
        ...
        (x_train, y_train), (x_test, y_test) = cifar100.load_data(label_model = 'fine')
...
def preprocessing_image(data_name, file, img_nrows, img_ncols):
